...
@section('title', 'Flight - '.env('APP_NAME'))
...
================================= -->
    <x-breadcrumb slug="Flight" image="bread-bg-6"/>
    <!-- end breadcrumb-area -->
    <!-- ================================
    END BREADCRUMB AREA
================================= -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            >
              <div class="card-img">
                <img src="{{ asset('frontend/images/airline-img8.png') }}" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
            ...
            >
              <div class="card-img">
                <img src="{{ asset('frontend/images/airline-img9.png') }}" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
            ...
            >
              <div class="card-img">
                <img src="{{ asset('frontend/images/airline-img10.png') }}" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
            ...
            >
              <div class="card-img">
                <img src="{{ asset('frontend/images/airline-img11.png') }}" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
