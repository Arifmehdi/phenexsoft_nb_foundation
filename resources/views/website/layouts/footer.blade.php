  <footer id="footer" class="footer" data-bg-img="{{ asset('frontend') }}/images/footer-bg.png" data-bg-color="#25272e">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-inline mt-5">
              ...
              <!-- <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored mr-5"></i> <a class="text-gray" href="#"><span class="__cf_email__" data-cfemail="2e4d41405a4f4d5a6e57415b5c4a41434f4740004d4143">[email&#160;protected]</span></a> </li> -->
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored mr-5"></i> <a class="text-gray" href="#"><span class="__cf_email__" data-cfemail="2e4d41405a4f4d5a6e57415b5c4a41434f4740004d4143">{{ $ws->contact_email }}</span></a> </li>
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-15 pb-10">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-black-777 m-0">Copyright &copy;2025 Phenexsoft. All Rights Reserved</p>
          </div>
