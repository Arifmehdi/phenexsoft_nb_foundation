...
@section('title', 'Tour - '.env('APP_NAME'))
...
================================= -->
    ...
    <x-breadcrumb slug="Tour" image="bread-bg"/>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="{{ asset('frontend/images/img9.jpg') }}" alt="Destination-img" />
                </a>
                <div
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="{{ asset('frontend/images/img10.jpg') }}" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="{{ asset('frontend/images/img11.jpg') }}" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="{{ asset('frontend/images/img12.jpg') }}" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="{{ asset('frontend/images/img13.jpg') }}" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="{{ asset('frontend/images/img14.jpg') }}" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
