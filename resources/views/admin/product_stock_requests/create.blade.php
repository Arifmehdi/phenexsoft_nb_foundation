...
@section('title',"Admin Dashboard | Create Product Stock Request")
...
<section class="pt-3">
    <div class="card">
        <div class="card-header bg-info">
            <div class="card-title">Create New Product Stock Request</div>
        </div>
        <form action="{{ route('admin.stock_requests.store') }}" method="POST">
            ...
            <div class="card-footer text-right">
                <input type="submit" class="btn btn-success mt-2" value="Save Request">
            </div>
        </form>
    </div>
</section>
